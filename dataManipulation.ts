...
const withTotalCost=rawData.map(item=>({ totalCost: item.price* item.quantity
}))
/*console.log(withTotalCost);*/
const sortedData = withTotalCost.sort((a, b) => a.totalCost - b.totalCost);
/*console.log(sortedData);*/

/*function map(array: number[]): number[] {
    const result:number[]=[];
